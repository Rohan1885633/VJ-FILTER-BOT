...
API_ID = int(environ.get('API_ID', '21593885'))
API_HASH = environ.get('API_HASH', '66c868b925a30a3deb21c300a69d1425)
BOT_TOKEN = environ.get('BOT_TOKEN', "6736577527:AAFf0ay4ckg5NUiNIdIjYl0fYNq20ZEqDBk")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1303970665').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001891085801').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Rohankumar188:71zMWk875dgEQwwi@cluster0.ez6mpft.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Rohan188")
