...
BOT_TOKEN = environ.get('BOT_TOKEN', "7882041123:AAHJC1mg6t86LPPWqGi8y3FZJrVCHPni96A")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7840798798').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002349285895').split()]
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/The_Movies_Officially')
